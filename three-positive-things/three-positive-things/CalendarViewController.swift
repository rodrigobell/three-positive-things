...
class CalendarViewController: UIViewController {
  ...
  func goToToday() {
    Analytics.logEvent("tapped_today_btn", parameters: nil)
...
extension CalendarViewController: JTAppleCalendarViewDataSource, JTAppleCalendarViewDelegate {
  ...
  func calendar(_ calendar: JTAppleCalendarView, didSelectDate date: Date, cell: JTAppleDayCellView?, cellState: CellState) {
    Analytics.logEvent("date_changed", parameters: nil)
    handleCellSelection(view: cell, date: date, cellState: cellState)
    handleCellTextColor(view: cell, date: date, cellState: cellState)
  ...
  func calendar(_ calendar: JTAppleCalendarView, didScrollToDateSegmentWith visibleDates: DateSegmentInfo) {
    Analytics.logEvent("changed_month", parameters: nil)
...
extension CalendarViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    Analytics.logEvent("selected_positive_thing_cell", parameters: ["row": indexPath.row])
    saveThingsToDate()
  }
}
